...
.EXAMPLE
LIST APPLICATIONS
.\NetMon.ps1 -url "https://1.2.3.4" -username "bob" -password "GUID" -path "/applications" -method "GET" 

DOWNLOAD PCAP
.\NetMon.ps1 -url "https://1.2.3.4" -username "bob" -password "GUID" -path "/pcap/action/download" -method "POST" -Outfile "test2" -session "577c3ef6-cca3-41d7-a4cd-81783dfbd292" 

RESTART NETMON SERVICES
.\NetMon.ps1 -url "https://1.2.3.4" -username "bob" -password "GUID" -path "/services/actions/restart" -method "PUT" 

GET CAPTURE STATE
.\NetMon.ps1 -url "https://1.2.3.4" -username "bob" -password "GUID" -path "/services/capture" -method "GET"

GET SESSION
.\NetMon.ps1 -url "https://1.2.3.4" -username "bob" -password "GUID" -path "/session/577c3ef6-cca3-41d7-a4cd-81783dfbd292" -session "577c3ef6-cca3-41d7-a4cd-81783dfbd292" -method "GET"

GET SESSION FILES
.\NetMon.ps1 -url "https://1.2.3.4" -username "bob" -password "GUID" -path "/session/577c3ef6-cca3-41d7-a4cd-81783dfbd292/files" -session "577c3ef6-cca3-41d7-a4cd-81783dfbd292" -method "GET" -outFile "files.zip"


.PARAMETER 

$username -> Netmon username
