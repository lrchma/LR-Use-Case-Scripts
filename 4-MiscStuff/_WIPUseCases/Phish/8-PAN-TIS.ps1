...
$log = "1,$generatedTime,001801011183,TRAFFIC,end,0,$receivedTime,$srcip,$dstip,0.0.0.0,$dstip,Allow_ACME_Internet,,,incomplete,vsys1,z-ACME-cxc,z-ACME Link,ethernet1/3.251,ethernet1/1,ACME_Syslog,$receivedTime,115005,1,$sport,$dport,42096,80,0x40401c,tcp,allow,380,258,122,6,2$receivedTime,18,any,0,69169405283,0x0,$ipRange.0-$ipRange.255,US,0,4,2,tcp-fin"
